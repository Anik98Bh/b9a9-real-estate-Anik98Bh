...
const Navbar = () => {
    ...
    return (
        <div className="navbar rounded fixed z-10 px-5 animate__animated animate__flip">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost text-3xl font-bold"><span className="text-green-500">AB</span> Real Estate</a>
            </div>
