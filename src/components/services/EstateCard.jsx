...
const EstateCard = ({ estate }) => {
    ...
    return (
        <div className="card lg:w-96 bg-base-100 shadow-xl mb-3 hover:bg-violet-100 active:bg-violet-100 focus:outline-none focus:ring focus:ring-violet-300 animate__animated animate__zoomIn animate__delay-2s">
